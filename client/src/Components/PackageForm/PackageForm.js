...
import { createPackage, getsinglePackage, updatePackage } from '../../actions/service'
...
const PackageForm = () => {
    ...
    let { id } = useParams()
    const [packages, setPackages] = useState({ packagename: '', packagedescription: '', servicesArr: [] })
        ...
        <div className="m-9" >
            <form onSubmit={handleSubmit}>
                ...
                <div className="mb-6">
                    ...
                    <input type="text" id="base-input" value={packages.packagedescription} onChange={(e) => setPackages({ ...packages, packagedescription: e.target.value })} className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" />
                </div>
